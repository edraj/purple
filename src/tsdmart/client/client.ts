...
import type { IAssetRequest } from './models/asset.model';
import type { IEntryQuery, IEntryResponse } from './models/entry.model';
import type { IClientError } from './models/error.model';
import type { IFileRequest } from './models/file.model';
import { EnumStatus, type IQueryRequest, type typeScope } from './models/query.model';
import type { IRecordWithAttachment, IResponseList } from './models/record.model';
import type { IRequest, ISubmitRequest } from './models/request.model';
import type { ITicketRequest } from './models/ticket.model';
